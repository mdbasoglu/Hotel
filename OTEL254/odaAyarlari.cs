...
namespace OTEL254
{
    public partial class odaAyarlari : Form
    {
        ...
        private void dGvOdaAyarlari_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                tOda.Text = label_secilenoda.Text = dGvOdaAyarlari.SelectedRows[0].Cells[0].Value.ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                programAyarlari.fodalar.panel2.Controls.Clear();
                programAyarlari.fgiris.odalar();
            }
            catch (Exception)
            {
