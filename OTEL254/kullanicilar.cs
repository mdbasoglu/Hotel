    ...
    public partial class kullanicilar : Form
    {
        ...
        private void bKullaniciEkle_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                dataR["K_TC"] = tTC.Text.Trim();
                dataR["K_KADI"] = tKadi.Text.Trim();
                dataR["K_SIFRE"] = tSifre.Text.Trim();
                dataR["K_ADI_SOYADI"] = tAdSoyad.Text.Trim();
                dataR["K_DOGUM_TARIHI"] = dTpDogumTarihi.Text.Trim();
                dataR["K_TEL"] = tTel.Text.Trim().Replace(" ", string.Empty);
                dataR["K_ADRES"] = tAdres.Text.Trim();
                dataR["K_KISISEL_BILGILER"] = tKisisel.Text.Trim();
                dataR["K_Y_ADI"] = cYetki.Text.Trim();
